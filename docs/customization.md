...
This guide provides comprehensive information on how to customize your portfolio
website, leveraging the modular design system for consistent and attractive
results.
...
The color system is built around primary, neutral, and accent color palettes. To
customize:
...
See the full [Design System Documentation](design-system.md) for complete color
palette details.

### Stylesheet Output

The theme links `css/style.css` by default. Override the path from site
configuration when your compiled CSS lives somewhere else:
...
The design system provides pre-styled components that can be customized while
...
The base template can be customized while maintaining the design system's
structure:
...
>
  {{ partial "head.html" . }}
  <body
    class="bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 transition-colors duration-300"
  >
    {{ partial "header.html" . }}
    <main class="min-h-screen">{{ block "main" . }}{{ end }}</main>
    {{ partial "footer.html" . }}
  </body>
</html>
```
...
<section class="py-16 bg-neutral-50 dark:bg-neutral-800">
  <div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      partial "components/project-card.html" . }} {{ end }}
    </div>
...
title: "Home" description: "Professional portfolio showcasing my work and
expertise" sections:

- type: hero title: "I build beautiful digital experiences" subtitle: "Frontend
  Developer & UI Designer" buttons:
  - label: "View Projects" url: "/projects" style: "primary"
  - label: "Contact Me" url: "/contact" style: "outline" image:
    "images/hero.jpg"

- type: featured-projects title: "Selected Work" count: 3
- type: skills title: "My Skills" columns: 3
- type: testimonials title: "What Clients Say" count: 2
...
<article class="py-12">
  <div class="container mx-auto px-4">
    ...
    <div class="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <a
        href="{{ .Permalink }}"
        class="card card-bordered hover:-translate-y-1"
      >
        <div class="card-body">
      ...
      <a
        href="{{ .Permalink }}"
        class="card card-bordered hover:-translate-y-1 md:text-right md:ml-auto"
      >
        <div class="card-body">
          <span class="text-sm text-neutral-500 dark:text-neutral-400"
            >Next Project</span
...
<div
  class="grid grid-cols-1 gap-y-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-8 xl:grid-cols-4"
>
  {{ range .items }}
...
For a complete overview of the design system, see the
